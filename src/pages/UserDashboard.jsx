...
function UserDashboard() {
  ...
  const quickActions = [
    ...
    {
      path: "/raise-concern", cls: "ud-action-rose", name: t("raiseConcern") || "Raise a Concern", sub: t("raiseConcernSub") || "We're here to listen",
      icon: (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /><line x1="12" y1="8" x2="12" y2="12" /><line x1="12" y1="15" x2="12.01" y2="15" /></svg>)
    },
  ];
